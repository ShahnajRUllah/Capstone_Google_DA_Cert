---
title: "fitbit_consumer_usage_data_analysis_v2"
author: Shahnaj Ullah
...
```{r importing minute logs for sleep and METs, include=FALSE}
...
```{r importing minute logs for calories, include=FALSE}
...
```{r importing heart rate and weight logs, include=FALSE}
...
4. We can visualize the similar trends the between daily calories burned and active minutes, steps, and total distance. 
...
hourlyly_user_avg <- hourly_averages %>%
